...
playerImg = pygame.image.load('logo.png') #setting the image to use as the player's icon
...
def message_display(message):
    textDef = pygame.font.Font('freesansbold.ttf',90)
    ...
    while changingCode:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_q:
                    pygame.quit()
        textDef = pygame.font.Font('freesansbold.ttf',25)
        ...
        menuButtons((display_width/17), (display_height - 800), score_width, score_height, red)
...
def game_loop():
    ...
    starting_platform_height = 210 #starting platform's height
